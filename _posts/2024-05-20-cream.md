...
The background color is `343b34` and the text is `e0d034`, which is hopefully cream text over an almost black green.

Rikki is rightly nervous that inappropriate details will wind up here and suggested a conversation about is with Mickettric Mann, who has been a fantastic pro-LGBTQ counselor.
